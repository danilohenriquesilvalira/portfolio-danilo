    ...
    >
      <div className="flex gap-4 sm:gap-6">
        ...
        <div className="relative flex flex-col items-center">
          <div
            className="relative z-10 w-14 h-14 sm:w-16 sm:h-16 rounded-full flex items-center justify-center shadow-lg flex-shrink-0"
        ...
        <div className="flex-1">
          <div className="bg-tertiary rounded-xl p-4 sm:p-6 shadow-lg hover:shadow-2xl transition-shadow duration-300">
            ...
            <div className="mt-4 pt-4 border-t border-gray-700">
              ...
              <div className="flex flex-wrap gap-2 justify-start">
                {allTechs.map((tech: string, index: number) => (
                  <span
                    key={`tech-${index}`}
                    className="bg-black-200 px-2 py-1 rounded-md text-xs text-white whitespace-nowrap hover:bg-tech-blue transition-colors duration-200"
                  >
                    {tech}
                  </span>
                ))}
    ...
    >
      <div className="flex gap-4 sm:gap-6">
        ...
        <div className="relative flex flex-col items-center">
          ...
          >
            <FaGraduationCap className="w-7 h-7 sm:w-8 sm:h-8 text-industry-green" />
          </div>
          <div className="absolute top-14 sm:top-16 bottom-0 w-0.5 bg-industry-green bg-opacity-30"></div>
        </div>
